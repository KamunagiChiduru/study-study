...
public class SampleView extends ViewPart implements SelectionListener{
	/**
	...
	public void widgetSelected(SelectionEvent event){
		try{
			final String source= Joiner
					.on("\n")
					.join( //
					Files.readAllLines( //
							new File(
									"C:/Users/USER1/Documents/sources/java/src/jp/michikusa/chitose/Simple.java")
									.toPath(), //
